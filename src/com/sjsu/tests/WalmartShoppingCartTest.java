...
public class WalmartShoppingCartTest {
	...
	public void googleSearch() throws Exception {
		...
		search.sendKeys("stroller");

		// Now submit the search criteria WebDriver will find the form for us from the element
		search.submit();

		Thread.sleep(1000);
		Assert.assertTrue(driver.getPageSource().contains("The First Years - Jet Lightweight Stroller, City Chic"),"Stroller not found");
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.quit();
